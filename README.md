...
**Author:** xspeen  
**Version:** 1.0.0  
**Classification:** Red Team / Ethical Hacking  
...
<img src="https://img.shields.io/badge/Parrot_OS-15E0B3?style=for-the-badge&logo=parrot&logoColor=white" alt="Parrot OS">
...
<img src="https://img.shields.io/badge/Penetration_Testing-Red_Team-red?style=for-the-badge" alt="Red Team">
<img src="https://img.shields.io/badge/Ethical_Hacking-Legal-green?style=for-the-badge" alt="Ethical Hacking">
<img src="https://img.shields.io/badge/Authorized_Use_Only-FF0000?style=for-the-badge" alt="Authorized Use Only">
<img src="https://img.shields.io/badge/Educational_Purposes-0055FF?style=for-the-badge" alt="Educational Purposes">
...
<img src="https://img.shields.io/badge/Status-Stable-green?style=for-the-badge" alt="Status Stable">
<img src="https://img.shields.io/badge/Last_Update-2024-brightgreen?style=for-the-badge" alt="Last Update">
<img src="https://img.shields.io/badge/Code_Quality-A+-success?style=for-the-badge" alt="Code Quality">

---

## OPERATING SYSTEMS QUICK COMMANDS
...
This tool is designed for authorized penetration testing and security research only. Unauthorized access to computer systems is illegal under the Computer Fraud and Abuse Act (CFAA) and similar laws worldwide.
...
git clone https://github.com/xspeen/Git-Pish.git
cd Git-Pish
...
pkg install git python python-pip openssh -y
...
sudo apt update && sudo apt install git python3 python3-pip -y && git clone https://github.com/xspeen/Git-Pish.git && cd Git-Pish && pip3 install -r requirements.txt && python3 git-pish.py
...
pkg update && pkg upgrade -y && pkg install git python python-pip openssh -y && git clone https://github.com/xspeen/Git-Pish.git && cd Git-Pish && pip install -r requirements.txt && python3 git-pish.py

```

Termux with Full Storage Access
```

termux-setup-storage && pkg update && pkg upgrade -y && pkg install git python python-pip openssh -y && git clone https://github.com/xspeen/Git-Pish.git && cd Git-Pish && pip install -r requirements.txt && python3 git-pish.py
...
brew install git python3 && git clone https://github.com/xspeen/Git-Pish.git && cd Git-Pish && pip3 install -r requirements.txt && python3 git-pish.py
...
GitHub: https://github.com/xspeen

Report Issues: https://github.com/xspeen/Git-Pish/issues
